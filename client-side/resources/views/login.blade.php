        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    ...
                    <div
                        class="d-flex justify-content-center justify-content-lg-start text-center text-lg-start mt-4 pt-2">
                        <p class="mb-0">Belum punya akun? <a href="{{ route('register') }}" class="fw-bold">Daftar</a>
                        </p>
                    </div>
                </div>
            </div>
